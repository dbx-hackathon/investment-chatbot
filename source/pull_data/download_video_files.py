...
url = "https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults={maxResults}&regionCode=US&type=video&videoCaption=closedCaption&videoDuration={videoDuration}&order=viewCount&publishedAfter=2023-01-01T00:00:00Z&q=stock%20investment&key={api_key}".format(maxResults = maxResults, videoDuration = videoDuration, api_key = api_key)
...
f = open("./youtube_video_ids.txt", "a")
for item in video_ids:
    f.write(item + '\n')
f.close()

f = open("./youtube_video_urls.txt", "a")
